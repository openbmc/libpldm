 ...
 */
static inline int pldm_msgbuf_init(struct pldm_msgbuf *ctx, size_t minsize, const uint8_t *buf, size_t len)
{
	uint8_t *end;
 ...
 */
static inline int pldm_msgbuf_extract_uint8(struct pldm_msgbuf *ctx, uint8_t *dst)
{
	if (!ctx) {
		return -PLDM_ERROR_INVALID_DATA;
	}
...
static inline int pldm_msgbuf_extract_uint16(struct pldm_msgbuf *ctx, uint16_t *dst)
{
	uint16_t ldst;
...
static inline int pldm_msgbuf_extract_int16(struct pldm_msgbuf *ctx, int16_t *dst)
{
	int16_t ldst;
...
static inline int pldm_msgbuf_extract_uint32(struct pldm_msgbuf *ctx, uint32_t *dst)
{
	uint32_t ldst;
...
static inline int pldm_msgbuf_extract_int32(struct pldm_msgbuf *ctx, int32_t *dst)
{
	int32_t ldst;
...
static inline int pldm_msgbuf_extract_real32(struct pldm_msgbuf *ctx, real32_t *dst)
{
	uint32_t ldst;
...
#define pldm_msgbuf_extract(ctx, dst) _Generic((*(dst)), \
	...
	real32_t: pldm_msgbuf_extract_real32 \
	)(ctx, dst)
