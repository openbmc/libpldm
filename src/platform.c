					 ...
					 set_effecter_state_field *field)
{
	...
	rc = pldm_msgbuf_init(buf, 3, msg->payload, payload_length);
	if (rc) {
		return rc;
	}
					  ...
					  uint8_t effecter_value[4])
{
	...
	case PLDM_EFFECTER_DATA_SIZE_UINT8:
		pldm_msgbuf_extract_uint8(buf, (uint8_t *)effecter_value);
		break;
	case PLDM_EFFECTER_DATA_SIZE_SINT8:
		pldm_msgbuf_extract_int8(buf, (int8_t *)effecter_value);
		break;
	case PLDM_EFFECTER_DATA_SIZE_UINT16:
		pldm_msgbuf_extract_uint16(buf, (uint16_t *)effecter_value);
		break;
	case PLDM_EFFECTER_DATA_SIZE_SINT16:
		pldm_msgbuf_extract_int16(buf, (int16_t *)effecter_value);
		break;
	case PLDM_EFFECTER_DATA_SIZE_UINT32:
		pldm_msgbuf_extract_uint32(buf, (uint32_t *)effecter_value);
		break;
	case PLDM_EFFECTER_DATA_SIZE_SINT32:
		pldm_msgbuf_extract_int32(buf, (int32_t *)effecter_value);
		break;
	}
