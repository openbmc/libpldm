    ...
    struct pldm_numeric_sensor_value_pdr *pdr_value)
{
	...
	pdr_value->resolution = le32toh(*((real32_t *)ptr));
	ptr += sizeof(real32_t);

	pdr_value->offset = le32toh(*((real32_t *)ptr));
	ptr += sizeof(real32_t);
	...
	pdr_value->state_transition_interval = le32toh(*((real32_t *)ptr));
	ptr += sizeof(real32_t);

	pdr_value->update_interval = le32toh(*((real32_t *)ptr));
	ptr += sizeof(real32_t);
