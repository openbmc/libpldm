...
int tmp_pack_pldm_header_errno(const struct pldm_header_info *hdr,
					...
					struct pldm_msg *msg)
{
	...
	header.command = PLDM_QUERY_DOWNSTREAM_DEVICES;
	return tmp_pack_pldm_header_errno(&header, &(msg->hdr));
}
