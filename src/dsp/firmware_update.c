...
LIBPLDM_ABI_STABLE
int encode_update_security_revision_req(const uint8_t instance_id,
					const uint16_t comp_classification,
					const uint16_t comp_identifier,
					const uint8_t comp_classification_index,
					struct pldm_msg *msg,
					size_t payload_length)
{
	if (msg == NULL) {
