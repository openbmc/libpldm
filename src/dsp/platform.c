	...
	struct pldm_platform_redfish_resource_pdr_oem_name_info *oem_name_info)
{
	...
	additional_resource_info->count = pdr->additional_resource_id_count;
	additional_resource_info->area = pdr->additional_resources;
	...
	oem_name_info->count = pdr->oem_count;
	oem_name_info->area = pdr->oem_names;
		...
		*additional_resource_info)
{
	...
	iter->entries = additional_resource_info->count;
	...
	struct pldm_platform_redfish_resource_pdr_oem_name_info *oem_name_info)
{
	...
	iter->entries = oem_name_info->count;
	...
	struct pldm_platform_redfish_action_pdr_action_info *action_info)
{
	...
	iter->entries = action_info->count;
