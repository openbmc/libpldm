	...
	struct pldm_msg *msg)
{
	...
	fprintf(stderr, "str_len: %ld\n", str_len);
	fprintf(stderr, "payload_length: %ld\n", payload_length);
	...
	struct pldm_rde_varstring *provider_name)
{
	...
	fprintf(stderr, "payload_length: %ld\n", payload_length);
	fprintf(stderr, "device_concurrency_support: %d\n",
		*device_concurrency_support);
	fprintf(stderr, "string_length_bytes: %d\n",
		provider_name->string_length_bytes);
