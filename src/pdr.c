...
/*API to add a contained entity as a remote PDR to an existing entity association PDR. Remote PDRs are PDRs added to the host entity and not to the tree directly*/
