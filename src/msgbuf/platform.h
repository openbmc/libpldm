 ...
 * Note: Callers must ensure the destination buffer is large enough to
 * accommodate the effecter data size. Use pldm__msgbuf_extract_effecter_data()
 * for type-safe 64-bit effecter support.
 */
LIBPLDM_CC_ALWAYS_INLINE int
