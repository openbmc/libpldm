...
static bool is_tranfsfer_operation_flag_valid(uint8_t transfer_op_flag)
{
...
LIBPLDM_ABI_TESTING
int encode_query_downstream_identifiers_req(uint8_t instance_id,
					    ...
					    struct pldm_msg *msg)
{
	...
	struct pldm_query_downstream_identifiers_req *request =
		(struct pldm_query_downstream_identifiers_req *)msg->payload;
