 ...
 */
     ...
     *                                        matching device.
     */
		explicit PackageParser(
			PackageHeaderSize pkgHeaderSize,
     ...
     */
		size_t
		parseFDIdentificationArea(DeviceIDRecordCount deviceIdRecCount,
     ...
     */
		size_t
		parseCompImageInfoArea(ComponentImageCount compImageCount,
				       const std::vector<uint8_t> &pkgHdr,
				       size_t offset);
 ...
 */
     ...
     */
		explicit PackageParserV1(
			...
			const PackageVersion &pkgVersion,
			ComponentBitmapBitLength componentBitmapBitLength)
			: PackageParser(pkgHeaderSize, pkgVersion,
 ...
 */
	...
	parsePkgHeader(std::vector<uint8_t> &pkgHdrInfo);
