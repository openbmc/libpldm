...
Much of this is in addition to libpldm's `CONTRIBUTING.md` and there may be some
overlap. For the purpose of the C++ binding, expectations documented below take
priority.
