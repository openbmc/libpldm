...
TEST(EntityAssociationPDR, testFindParentEntity)
{
    ...
    container.entity_type = entities[0].entity_type;
    container.entity_instance_num = entities[0].entity_instance_num;
    container.entity_container_id = entities[0].entity_container_id;

    uint32_t record_handle = 0;
    bool found = false;

    int rc = pldm_entity_association_find_parent_entity(repo, &container, false,
                                                        &record_handle, &found);
    ...
    container.entity_type = 99;
    record_handle = 0;
    found = true;

    rc = pldm_entity_association_find_parent_entity(repo, &container, false,
                                                    &record_handle, &found);
