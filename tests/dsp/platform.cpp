...
std::array<uint8_t,
        ...
        encodedPDR{};
    auto rc= encode_numeric_sensor_pdr_data(&encodedPDR, encodedPDR.size(), &originalPDR);
    EXPECT_EQ(rc, PLDM_SUCCESS);

    struct pldm_numeric_sensor_value_pdr decodedPDR;

    rc = decode_numeric_sensor_pdr_data(&encodedPDR, encodedPDR.size(), &decodedPDR);
    ...
    EXPECT_EQ(decodedPDR.hdr.record_change_num, originalPDR.hdr.record_change_num);
    ...
    EXPECT_EQ(decodedPDR.aux_oem_unit_handle,
            originalPDR.aux_oem_unit_handle);
    ...
    EXPECT_EQ(decodedPDR.update_interval,
            originalPDR.update_interval);

    EXPECT_EQ(decodedPDR.max_readable.value_u8, originalPDR.max_readable.value_u8);
    EXPECT_EQ(decodedPDR.min_readable.value_u8, originalPDR.min_readable.value_u8);

    EXPECT_EQ(decodedPDR.range_field_format,
            originalPDR.range_field_format);
    EXPECT_EQ(decodedPDR.range_field_support.byte,
            originalPDR.range_field_support.byte);

    EXPECT_EQ(decodedPDR.nominal_value.value_u8, originalPDR.nominal_value.value_u8);
    ...
    EXPECT_EQ(decodedPDR.warning_high.value_u8, originalPDR.warning_high.value_u8);
    EXPECT_EQ(decodedPDR.warning_low.value_u8, originalPDR.warning_low.value_u8);
    EXPECT_EQ(decodedPDR.critical_high.value_u8, originalPDR.critical_high.value_u8);
    EXPECT_EQ(decodedPDR.critical_low.value_u8, originalPDR.critical_low.value_u8);
