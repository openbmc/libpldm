...
{
    const std::array<uint8_t, 186> package{
        0x7B, 0x29, 0x1C, 0x99, 0x6D, 0xB6, 0x42, 0x08, 0x80, 0x1B,
        0x02, 0x02, 0x6E, 0x46, 0x3C, 0x78, 0x04, 0xB4, 0x00, 0x00,
        0xe9, 0x07, 0x03, 0x0b, 0x16, 0x03, 0x00, 0x00, 0x00, 0x00,
        0x76, 0x02, 0x08, 0x00, 0x01, 0x04, 't',  'e',  's',  't',

        0x01, 0x1E, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01, 0x04,
        0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 'v',  '0',  '.',
        '1',  0x01, 0x00, 0x04, 0x00, 0x9c, 0x01, 0x00, 0x00, 0x87,
        0x65,

        0x01, 0x1E, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01, 0x04,
        0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x02, 'v',  '1',  '.',
        '0',  0x01, 0x00, 0x04, 0x00, 0x9c, 0x01, 0x00, 0x00, 0x87,
        0x65,

        0x02, 0x00,

        0x0a, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00,
        0x01, 0x00, 0xB4, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x01, 0x04, 'v',  '0',  '.',  '2',  0x04, 0x00, 0x00, 0x00,
        0x12, 0x34, 0x56, 0x78,

        0x0a, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00,
        0x01, 0x00, 0xB5, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x01, 0x04, 'v',  '2',  '.',  '0',  0x04, 0x00, 0x00, 0x00,
        0x12, 0x34, 0x56, 0x78,

        0xf7, 0xf7, 0xfd, 0x79, 0xd4, 0x9a, 0x10, 0xa4,
    ...
    foreach_pldm_package_firmware_device_id_record(iter, fdrec, rc)
    {
        ...
        static const uint8_t expected_exreference_manifest_data[] = {0x87, 0x65};
        ...
        EXPECT_NE(fdrec.record_descriptors.ptr, nullptr);
        ASSERT_EQ(fdrec.firmware_device_package_data.length, 0);
        EXPECT_EQ(fdrec.reference_manifest_data.length, sizeof(expected_exreference_manifest_data));
        EXPECT_EQ(memcmp(fdrec.reference_manifest_data.ptr,
                         expected_exreference_manifest_data,
                         sizeof(expected_exreference_manifest_data)),
                  0);
        foreach_pldm_package_firmware_device_id_record_descriptor(iter, fdrec,
                                                                  desc, rc)
        {
    ...
    static std::array<uint8_t, 4> expected_opaque_data = {0x12, 0x34, 0x56, 0x78};
