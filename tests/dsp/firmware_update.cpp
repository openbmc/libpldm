...
TEST(DecodePldmFirmwareUpdatePackage, v1h1fd1fdd1cii)
{
    ...
    EXPECT_NE(iter.hdr.package.ptr, nullptr);
    EXPECT_NE(iter.hdr.package.length, 0);
    ...
    static const pldm_component_image_information_pad expected_info{
...
TEST(DecodePldmFirmwareUpdatePackage, v2h1fd1fdd1dd1ddd2cii)
{
    ...
    static const std::array<pldm_component_image_information_pad, 2>
    ...
    foreach_pldm_component_image_information(iter, info, rc)
    {
        const pldm_component_image_information_pad* expected;
        const char* version;
        uint8_t image;
...
TEST(VerifyPayloadChecksum, ValidChecksum)
{
    ...
    const size_t payloadSize = static_cast<const size_t>(150 * 1024 * 1024);
