...
void setupContext()
{
    testContext = (struct requester_base_context *) malloc(sizeof(struct requester_base_context));
...
{
    setupContext();
    struct rde_pldm_request* request = (struct rde_pldm_request *) malloc(sizeof(struct rde_pldm_request));
