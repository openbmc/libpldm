...
TEST(decodeNumericSensorPdrData, Uint16Test)
{
    std::vector<uint8_t> pdr1{
        ...
        PLDM_PDR_NUMERIC_SENSOR_PDR_FIXED_LENGTH +
            PLDM_PDR_NUMERIC_SENSOR_PDR_NUMBER_OF_SENSOR_DATA *
                sizeof(uint16_t) +
            PLDM_PDR_NUMERIC_SENSOR_PDR_NUMBER_OF_RANGE_FIELD *
                sizeof(uint16_t),
        0, // dataLength
        0,
        0, // PLDMTerminusHandle
...
TEST(decodeNumericSensorPdrData, Sint16Test)
{
    std::vector<uint8_t> pdr1{
        ...
        PLDM_PDR_NUMERIC_SENSOR_PDR_FIXED_LENGTH +
            PLDM_PDR_NUMERIC_SENSOR_PDR_NUMBER_OF_SENSOR_DATA *
                sizeof(int16_t) +
            PLDM_PDR_NUMERIC_SENSOR_PDR_NUMBER_OF_RANGE_FIELD * sizeof(int16_t),
        0, // dataLength
        0,
        0, // PLDMTerminusHandle
        0x1,
...
TEST(decodeNumericSensorPdrData, Sint32Test)
{
    std::vector<uint8_t> pdr1{
        ...
        PLDM_PDR_NUMERIC_SENSOR_PDR_FIXED_LENGTH +
            PLDM_PDR_NUMERIC_SENSOR_PDR_NUMBER_OF_SENSOR_DATA *
                sizeof(int32_t) +
            PLDM_PDR_NUMERIC_SENSOR_PDR_NUMBER_OF_RANGE_FIELD * sizeof(int32_t),
        0, // dataLength
        0,
        0, // PLDMTerminusHandle
        0x1,
...
TEST(decodeNumericSensorPdrDataDeathTest, incorrectSensorDataSizeTest)
{
    // a good PDR but sensorDataSize is incorrect
    std::vector<uint8_t> pdr1{
        0x1,
        0x0,
        0x0,
...
TEST(decodeNumericSensorPdrDataDeathTest, incorrectRangeFieldFormatTest)
{
    // a good PDR but rangeFieldFormat is incorrect
    std::vector<uint8_t> pdr1{
        0x1,
        0x0,
        0x0,
