...
TEST(PollForPlatformEventMessage, testBadEncodeRequest)
{
    ...
    /*
     * transferOperationFlag is not PLDM_GET_FIRSTPART or PLDM_GET_NEXTPART or
    ...
    /*
     * transferOperationFlag is PLDM_GET_FIRSTPART and
     * eventIdToAcknowledge not 0x0000
     */
    transferOperationFlag = PLDM_GET_FIRSTPART;
    eventIdToAcknowledge = 0x1;
    ...
    /*
     * transferOperationFlag is not PLDM_GET_FIRSTPART and
     * eventIdToAcknowledge is 0x0000
     */
    transferOperationFlag = PLDM_GET_NEXTPART;
    eventIdToAcknowledge = 0x0;
    ...
    /*
     * transferOperationFlag is PLDM_GET_NEXTPART and
     * eventIdToAcknowledge not 0xffff
     */
    transferOperationFlag = PLDM_GET_NEXTPART;
    eventIdToAcknowledge = 0x1;
    ...
    /*
     * transferOperationFlag is not PLDM_GET_NEXTPART and
     * eventIdToAcknowledge is 0xffff
     */
    transferOperationFlag = PLDM_GET_FIRSTPART;
...
TEST(PollForPlatformEventMessage, testBadDecodeRequest)
{
    ...
    req->transfer_operation_flag = PLDM_ACKNOWLEDGEMENT_ONLY + 1;
    ...
    req->event_id_to_acknowledge = 0x1;
    ...
    req->event_id_to_acknowledge = 0x0;
     ...
     */
    req->transfer_operation_flag = PLDM_GET_FIRSTPART;
    req->event_id_to_acknowledge = 0xffff;
