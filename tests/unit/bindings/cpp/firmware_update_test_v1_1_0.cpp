...
TEST(PackageParserTest, ValidPkgV1_1_0_Minimal)
{
    ...
    0x00, 0x00, // DownstreamDevicePackageDataLength
    ...
    // DownstreamDevicePackageData (empty)
    //
        // clang-format on
    };
    ...
    auto res = PackageParser::parse(pkg, PackagePin::v1_1_0);
    ...
    EXPECT_EQ(dsDevice.downstreamDevicePackageData.size(), 0);
}
