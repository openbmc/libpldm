...
TEST(EntityAssociationPDR, testFindParentEntity)
{
    ...
    pldm_entity parent{};
    parent.entity_type = root->entity.entity_type;
    parent.entity_instance_num = root->entity.entity_instance_num;
    parent.entity_container_id = root->entity.entity_container_id;
    ...
    EXPECT_EQ(rc, 0);
    EXPECT_TRUE(found);
    EXPECT_NE(recordHandle, 0u);

    parent.entity_type = firstChild->entity.entity_type;
    parent.entity_instance_num = firstChild->entity.entity_instance_num;
    parent.entity_container_id = firstChild->entity.entity_container_id;
    ...
    EXPECT_EQ(rc, 0);
    EXPECT_FALSE(found);
    EXPECT_EQ(recordHandle, 0u);

    parent.entity_type = root->entity.entity_type;
    parent.entity_instance_num = 9999;
    parent.entity_container_id = root->entity.entity_container_id;
    ...
    parent.entity_type = root->entity.entity_type;
    parent.entity_instance_num = root->entity.entity_instance_num;
    parent.entity_container_id = 9999;
    ...
    rc = pldm_entity_association_find_parent_entity(repo, &parent, true,
                                                    &recordHandle, &found);
    ...
    EXPECT_EQ(pldm_entity_association_find_parent_entity(
                  nullptr, &parent, false, &recordHandle, &found),
              -EINVAL);
    EXPECT_EQ(pldm_entity_association_find_parent_entity(repo, nullptr, false,
                                                         &recordHandle, &found),
              -EINVAL);
    EXPECT_EQ(pldm_entity_association_find_parent_entity(repo, &parent, false,
                                                         nullptr, &found),
              -EINVAL);
    EXPECT_EQ(pldm_entity_association_find_parent_entity(
                  repo, &parent, false, &recordHandle, nullptr),
              -EINVAL);
