...
TEST(EntityAssociationPDR, testFindParentEntity)
{
    ...
    container.entity_type = entities[1].entity_type;
    container.entity_instance_num = entities[1].entity_instance_num;
    container.entity_container_id = entities[1].entity_container_id;
