...
TEST(EntityAssociationPDR, findAndAddRemotePDR)
{
    ...
    auto l6a = pldm_entity_association_tree_add_entities(
    ...
    auto l7a = pldm_entity_association_tree_add_entities(
