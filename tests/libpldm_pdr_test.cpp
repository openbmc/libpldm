...
TEST(EntityAssociationPDR, testPDR)
{
    ...
    EXPECT_NE(l2a, nullptr);
    auto* l2b = pldm_entity_association_tree_add(
        tree, &entities[2], 0xFFFF, l1, PLDM_ENTITY_ASSOCIAION_LOGICAL);
    EXPECT_NE(l2b, nullptr);
    auto* l2c = pldm_entity_association_tree_add(
        tree, &entities[3], 0xFFFF, l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l2c, nullptr);
    auto* l2d = pldm_entity_association_tree_add(
        tree, &entities[4], 0xFFFF, l1, PLDM_ENTITY_ASSOCIAION_LOGICAL);
    ...
    EXPECT_NE(l3b, nullptr);
    auto* l3c = pldm_entity_association_tree_add(
        tree, &entities[7], 0xFFFF, l2a, PLDM_ENTITY_ASSOCIAION_LOGICAL);
...
TEST(EntityAssociationPDR, testEntityInstanceNumber)
{
    ...
    auto* l1 = pldm_entity_association_tree_add(
        tree, &entities[1], 63, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto* l2 = pldm_entity_association_tree_add(
        tree, &entities[2], 37, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto* l3 = pldm_entity_association_tree_add(
        tree, &entities[3], 44, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto* l4 = pldm_entity_association_tree_add(
        tree, &entities[4], 89, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto* l5 = pldm_entity_association_tree_add(
        tree, &entities[5], 0xFFFF, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto* l6 = pldm_entity_association_tree_add(
        tree, &entities[6], 90, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_EQ(l6, nullptr);

    auto* l7 = pldm_entity_association_tree_add(
        tree, &entities[7], 100, l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto* l8 = pldm_entity_association_tree_add(
        tree, &entities[8], 100, l2, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
