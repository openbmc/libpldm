...
static constexpr size_t OEM_META_DECODE_WRITE_FILE_IO_REQ_BYTES = 9;
static constexpr size_t POST_CODE_SIZE = 4;
static constexpr size_t INVALID_DATA_SIZE = 0;
...
TEST(DecodeOemMetaFileIoReq, testInvalidDataRequest)
{
    ...
    std::array<uint8_t, INVALID_DATA_SIZE> retDataField{};
