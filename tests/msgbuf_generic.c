...
static void test_msgbuf_extract_generic_uint8(void)
{
    ...
    expect(pldm_msgbuf_init_cmdcode(ctx, sizeof(buf), buf, sizeof(buf)) ==
           PLDM_SUCCESS);
...
static void test_msgbuf_insert_generic_int32(void)
{
    ...
    expect(pldm_msgbuf_init_cmdcode(ctx, 0, buf, sizeof(buf)) == PLDM_SUCCESS);
    expect(pldm_msgbuf_insert(ctx, src) == PLDM_SUCCESS);

    struct pldm_msgbuf _ctxExtract;
    struct pldm_msgbuf* ctxExtract = &_ctxExtract;

    expect(pldm_msgbuf_init_cmdcode(ctxExtract, 0, buf, sizeof(buf)) ==
           PLDM_SUCCESS);
...
static void test_msgbuf_insert_generic_uint16(void)
{
    ...
    expect(pldm_msgbuf_init_cmdcode(ctx, 0, buf, sizeof(uint16_t)) ==
           PLDM_SUCCESS);
    expect(pldm_msgbuf_insert(ctx, src) == PLDM_SUCCESS);
