...
- dsp: platform: Add `encode_pldm_platform_state_sensor_pdr()`,
  `encode_pldm_platform_state_sensor_possible_states()` and their PDR structs
  (DSP0248 v1.3.0)
- dsp: platform: Add `decode_pldm_platform_state_sensor_pdr()` (DSP0248 v1.3.0)
...
- dsp: platform: Add `decode_pldm_platform_set_state_sensor_enables_req()`
...
- dsp: platform: Remove `decode_set_state_sensor_enables_req()` and associated
  types, replaced by `decode_pldm_platform_set_state_sensor_enables_req()`
