...
- platform: Added `decode_pldm_platform_effecter_auxiliary_names_pdr()`
- platform: Added `foreach_pldm_platform_effecter_auxiliary_name()` macro
- platform: Added `foreach_pldm_platform_effecter_aux_name()` macro
