...
- firmware_update: Add GetDeviceMetaData command
  - Add `encode_get_device_meta_data_req()`
  - Add `decode_get_device_meta_data_resp()`
...
- rde: Add RDEMultipartSend command
  ...
  - Add `encode_pldm_rde_multipart_send_resp()`
  - Add `decode_pldm_rde_multipart_send_resp()`
- rde: Add RDEOperationEnumerate command
  - Add `encode_pldm_rde_operation_enumerate_req()`
  - Add `decode_pldm_rde_operation_enumerate_req()`
  - Add `encode_pldm_rde_operation_enumerate_resp()`
  - Add `decode_pldm_rde_operation_enumerate_resp()`
  - Add `decode_pldm_rde_op_entry_from_iter()` and `foreach_pldm_rde_op_entry()`
- rde: Add RDEOperationStatus command
  - Add `encode_pldm_rde_operation_status_req()`
  - Add `decode_pldm_rde_operation_status_req()`
  - Add `encode_pldm_rde_operation_status_resp()`
  - Add `decode_pldm_rde_operation_status_resp()`
- rde: Add RDEOperationComplete command
  - Add `encode_pldm_rde_operation_complete_req()`
  - Add `decode_pldm_rde_operation_complete_req()`
  - Add `encode_pldm_rde_operation_complete_resp()`
  - Add `decode_pldm_rde_operation_complete_resp()`
...
- rde: Add GetResourceETag command
  ...
  - Add `encode_pldm_rde_get_resource_etag_resp()`
  - Add `decode_pldm_rde_get_resource_etag_resp()`
