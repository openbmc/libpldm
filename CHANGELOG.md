...
8. pdr: Add pldm_entity_association_pdr_remove_contained_entity()
9. pdr: Add pldm_pdr_remove_fru_record_set_by_rsi()
...
4. msgbuf: Allow pldm_msgbuf_span_required() to accept NULL
