...
8. Add firmware update FD responder

9. Add PLDM control responder. PLDM types and support commands/versions can be
   registered.

10. PLDM FD responder accepts a PLDM control handle and will register its
    version.
