...
enum pldm_platform_file_class {
	...
	PLDM_PLATFORM_FILE_CLASS_DIAGNOSTIC_LOGO = 0x04,
	PLDM_PLATFORM_FILE_CLASS_CRASH_DUMP_FILEO = 0x05,
	PLDM_PLATFORM_FILE_CLASS_SECURITY_LOGO = 0x06,
	PLDM_PLATFORM_FILE_CLASS_FRU_DATA_FILEO = 0x07,
	PLDM_PLATFORM_FILE_CLASS_TELEMETRY_DATA_FILEO = 0x08,
	PLDM_PLATFORM_FILE_CLASS_TELEMETRY_DATA_LOGO = 0x09,
