 ...
 * @param additional_resource The @ref "struct pldm_platform_redfish_resource_pdr_additional_resource" lvalue into which the next parameter table entry should be decoded
