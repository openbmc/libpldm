 ...
 *
 *  @param[in] instance_id - Message's instance id
 *  @param[in] req - Pointer to structure containing the request message fields:
 *                   - effecter_id: used to identify and access the effecter
 *                   - effecter_operational_state: The state of numeric effecter
 *                     being requested. Valid values are:
 *                     - EFFECTER_OPER_STATE_ENABLED_UPDATEPENDING
 *                     - EFFECTER_OPER_STATE_ENABLED_NOUPDATEPENDING
 *                     - EFFECTER_OPER_STATE_DISABLED
 *                     - EFFECTER_OPER_STATE_UNAVAILABLE
 ...
 *          - -EINVAL: msg or req is NULL or effecter_operational_state is invalid
