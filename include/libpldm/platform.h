 ...
 *  @param[in] pdr_length - expect length of the decoded pdr struct
 *
 ...
 *          length is not valid, -EBADMSG if the original length of the data
 *          buffer is larger than the target extract length, -EOVERFLOW if
 *          the original length of the data buffer is smaller than the target
 *          extract length
 */
