...
enum pldm_platform_file_class {
	...
	PLDM_PLATFORM_FILE_CLASS_BOOT_LOG,
	PLDM_PLATFORM_FILE_CLASS_SERIAL_TX_FIFO,
	PLDM_PLATFORM_FILE_CLASS_SERIAL_RX_FIFO,
	PLDM_PLATFORM_FILE_CLASS_DIAGNOSTIC_LOG,
	PLDM_PLATFORM_FILE_CLASS_CRASH_DUMP_FILE,
	PLDM_PLATFORM_FILE_CLASS_SECURITY_LOG,
	PLDM_PLATFORM_FILE_CLASS_FRU_DATA_FILE,
	PLDM_PLATFORM_FILE_CLASS_TELEMETRY_DATA_FILE,
	PLDM_PLATFORM_FILE_CLASS_TELEMETRY_DATA_LOG,
