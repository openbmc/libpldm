...
enum pldm_firmware_update_transfer_result_values {
	...
	PLDM_FWUP_FD_ABORTED_TRANSFER_INVALID_COMPONENET_OPAQUE_DATA = 0x0e,
	PLDM_FWUP_FD_ABORTED_TRANSFER_DOWNSTREAM_DEVICE_UPDATE_INPROGRESS =
		0x0f,
	PLDM_FWUP_TRANSFER_ABORTED_SECURITY_REVISION_ERROR = 0x10,
...
enum pldm_firmware_update_verify_result_values {
	...
	PLDM_FWUP_VERIFY_ERROR_SECURITY_REVISION_ERROR = 0x10,
...
enum pldm_firmware_update_apply_result_values {
	...
	PLDM_FWUP_APPPL_FAILURE_SECURITY_REVISION_ERROR = 0x10,
