 ...
 * @param[in] range_exclude_end_handle - last record handle in the range of
 * the remote endpoint which is ignored
 * @param[out] container_id - container id of the contained entity
 *
 * @return container id of the PDR record found on success, 
 * -EINVAL when repo is NULL, or -ENOKEY if the container id is not found.
 */
