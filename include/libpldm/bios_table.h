 ...
 * pldm_bios_table_attr_entry_enum_decode_pv_num. pv_num may be less than the
 * value provided by @ref pldm_bios_table_attr_entry_enum_decode_pv_num, in
 * which case only the first pv_num handles will be decoded.
 */
