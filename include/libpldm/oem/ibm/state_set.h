...
/** @brief IBM OEM New State Set IDs, updated the values of PCIe Slot
 * sensor n effecteor */
enum pldm_ibm_oem_pldm_state_set_ids {
	PLDM_OEM_IBM_FIRMWARE_UPDATE_STATE_ID = 32768,
	PLDM_OEM_IBM_BOOT_STATE_ID = 32769,
	PLDM_OEM_IBM_VERIFICATION_STATE_ID = 32770,
	PLDM_OEM_IBM_SYSTEM_POWER_STATE_ID = 32771,
	PLDM_OEM_IBM_SBE_MAINTENANCE_STATE_ID = 32772,
	PLDM_OEM_IBM_SBE_HRESET_STATE_ID = 32776,
	PLDM_OEM_IBM_PCIE_SLOT_EFFECTER_STATE_ID = 32779,
	PLDM_OEM_IBM_PCIE_SLOT_SENSOR_STATE_ID = 32780,
	PLDM_OEM_IBM_PCIE_TOPOLOGY_ACTIONS_ID = 32781,
};
