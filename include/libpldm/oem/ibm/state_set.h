...
enum pldm_oem_ibm_slot_enable_effecter_state {
	PLDM_OEM_IBM_ADD = 0x1,
	PLDM_OEM_IBM_REMOVE = 0x2,
	PLDM_OEM_IBM_REPLACE = 0x3,
};

enum pldm_oem_ibm_slot_enable_sensor_state {
	PLDM_OEM_IBM_SLOT_STATE_UNKOWN = 0x0,
	PLDM_OEM_IBM_SLOT_STATE_ENABLED = 0x1,
	PLDM_OEM_IBM_SLOT_STATE_DISABLED = 0x2,
	PLDM_OEM_IBM_SLOT_STATE_ERROR = 0x03,
};
