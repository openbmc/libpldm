...
enum pldm_bios_commands {
	...
	PLDM_UPDATE_BIOS_TABLE = 0x03,
	PLDM_GET_BIOS_TABLE_TAGS = 0x04,
	PLDM_SET_BIOS_TBALE_TAGS = 0x05,
	PLDM_ACCEPT_BIOS_ATTRIBUTES_PENDING_VALUES = 0x06,
	PLDM_SET_BIOS_ATTRIBUTE_CURRENT_VALUE = 0x07,
	PLDM_GET_BIOS_ATTRIBUTE_CURRENT_VALUE_BY_HANDLE = 0x08,
	PLDM_GET_BIOS_ATTRIBUTE_PENDING_VALUE_BY_HANDLE = 0x09,
	PLDM_GET_BIOS_ATTRIBUTE_CURRENT_VALUE_BY_TYPE = 0x0a,
	PLDM_GET_BIOS_ATTRIBUTE_PENDING_VALUE_BY_TYPE = 0x0b,
	PLDM_GET_DATE_TIME = 0x0c,
	PLDM_SET_DATE_TIME = 0x0d,
	PLDM_GET_BIOS_STRING_TABLE_STRING_TYPE = 0x0e,
	PLDM_SET_BIOS_STRING_TABLE_STRING_TYPE = 0x0f,
};
