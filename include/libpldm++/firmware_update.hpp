...
namespace fw_update
{
	...
	struct DescriptorData : libpldm::GrowableStruct<struct DescriptorData>,
		...
		// these are holding a map of descriptors, they need to be friends
		// in order to use the private copy constructor
		friend struct FirmwareDeviceIDRecord;
		friend struct DownstreamDeviceIDRecord;
	...
	struct FirmwareDeviceIDRecord
		...
		// ABI changed in PackagePin::v1_3_0_amend
